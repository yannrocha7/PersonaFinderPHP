...
<body>
<h2>Alterar senha</h2>
<form method="post" action="altera_senha_aluno.php">
    ...
    <button type="button" onclick="window.location.href='esqueci_senha_aluno.php';" class="btn btn-primary btn-block">Voltar</button>
</form>
</body>
</html>