            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Atualizar a ficha</a></li>
        ...
        <!-- Portfolio Section-->
          ...
          <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="atualizando_ficha.php" method="POST">
                            <div class="form-group">
                                <label for="treino">Adicionar Treino/Observações:</label>
                                <input type="hidden" name="cpfAluno" id="cpfAluno" value="<?php echo $alunoCpf; ?>">
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="6"  id="treino" name="treino" placeholder="Digite o treino" required><?php echo $treino; ?></textarea>
                            </div><br/>
