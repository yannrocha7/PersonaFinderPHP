        ...
        <!-- Portfolio Section-->
           ...
           <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Contratar</h2><br>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text"><?php echo $tipo_pagamentoPersonalAluno; ?> </p>
                            </div>
                            <div class="card-footer">
                                <a href="contratar.php?cpfPersonal=<?php echo $cpfPersonal; ?>" class="btn btn-success">Contratar</a>
                                <a href="index_aluno.php" class="btn btn-primary">Voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
