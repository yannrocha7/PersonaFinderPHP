<?php
    ...
    $sqlUpdateContrato = "UPDATE personal_aluno_contratacao SET proposta_aceita = 1 WHERE personal_cpf = '$cpf' AND aluno_cpf = '$cpfAluno'";
    if ($conn->query($sqlUpdateContrato) === TRUE) {
