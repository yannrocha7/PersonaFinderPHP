        ...
        <!-- Portfolio Section-->
          ...
          <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Alunos</h2><br>
                ...
                if ($resultproposta && $resultproposta->num_rows > 0) {
                    while ($row = $resultproposta->fetch_assoc()) {
                        $id = $row["id"];
                                ...
                                <div class="col-lg-4 col-sm-6 mb-4">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer">
                                            <a  href="fazer_contrato.php?cpfAluno=<?php echo $alunoCpf; ?>" class="btn btn-success">Aceitar</a>
                                            <a  href="negar_contrato.php?cpfAluno=<?php echo $alunoCpf; ?>" class="btn btn-danger">Negar</a>
                                        </div>
                                    </div>
                                </div>
