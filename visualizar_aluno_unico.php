            ...
            <div class="container">   
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Ver aluno</a></li>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted"><?php echo $Alunotelefone; ?></h6>
                            ...
                            <div class="card-footer">
                                ...
                                <?php endif; ?><br/>
                                <a  href="mandar_mensagem.php?telefone=<?php echo $Alunotelefone; ?>" target="_blank" class="btn btn-success">Mande uma mensagem via WhatsApp para seu aluno</a>
                            </div>
                        </div>
                    </div>
